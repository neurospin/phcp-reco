...
def createCommand_T2starSingleCompartmentRelaxometryMapper(fileNameMGE,
                                           fileNameMask,
                                           fileNameTEValues,
...
def create_ConfidenceMap(fileNameMGE, fileNameFittedMGE, fileNameMask, fileNameT2starnifti):
    ...
    ni_im = ni.Nifti1Image(dearrange_ArrayToFlipHeaderFormat(std_diff), metaT2starnifti.affine, metaT2starnifti.header)
    return ni_im


def runT2StarRelaxometryMapper( subjectDirectoryGisConversion,
                            MGEFilenames,
                            outputDirectory,
                            verbose ):
    ...
    t2starFileName = os.path.join( subjectDirectoryGisConversion, 't2star_extracted.nii.gz' )
    ...
    command = createCommand_T2starSingleCompartmentRelaxometryMapper(fileNameMGE,
                                            fileNameMask,
                                            fileNameTEValues,
                                            fileNameProtonDensity,
                                            fileNameT2star,
    ...
    ni_im = create_ConfidenceMap(fileNameMGE, fileNameFittedMGE, fileNameMask, fileNameT2star)
...
parser.add_option( '-i', '--input',
                   dest = 'mgedirectory',
                   help = 'MEGRE Directory' )
parser.add_option( '-m', '--mge',
                   dest = 'MGEFilenames',
...
runT2StarRelaxometryMapper( options.mgedirectory,
                       options.MGEFilenames,
